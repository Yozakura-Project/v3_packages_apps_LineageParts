...
package org.yozakuraos.yozakuraparts.egg.octo;
...
public class OctopusDrawable extends Drawable {
    ...
    private static final int BODY_COLOR   = 0xFFF8BBD0;
    private static final int ARM_COLOR    = 0xFF3E2233;
    private static final int LINE_COLOR   = 0xFF3E2233;
    ...
    public OctopusDrawable(Context context) {
        ...
        mEyeLogo = context.getResources().getDrawable(R.drawable.octo_yozakura_logo, context.getTheme());
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        canvas.save();
        {
            ...
            canvas.save();
            {
                canvas.translate(mCenter.x - 17f, mCenter.y - 15f);
                mEyeLogo.setBounds(0, 0, 34, 34); // YozakuraOS: square yozakura logo
