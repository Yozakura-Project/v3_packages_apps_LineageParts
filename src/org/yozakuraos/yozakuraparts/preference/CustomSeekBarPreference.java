...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public CustomSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            // YozakuraOS: read through the styleable rather than upstream's raw
            // getAttributeValue(SETTINGS_NS, ...), which names the com.android.settings
            // package and cannot be linked from here.
            mInterval = a.getInt(R.styleable.CustomSeekBarPreference_interval, mInterval);
            mMinValue = a.getInt(R.styleable.CustomSeekBarPreference_min, mMinValue);
        } finally {
            a.recycle();
        }
