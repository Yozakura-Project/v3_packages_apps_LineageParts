...
public class YozakuraInputFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.yozakura_input);
        getActivity().setTitle(R.string.yozakura_input_category);
    }
}
