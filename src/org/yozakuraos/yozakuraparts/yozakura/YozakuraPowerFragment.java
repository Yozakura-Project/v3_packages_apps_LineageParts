...
public class YozakuraPowerFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.yozakura_power);
        getActivity().setTitle(R.string.yozakura_power_category);
    }
}
