...
public class YozakuraStatusBarFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.yozakura_statusbar);
        getActivity().setTitle(R.string.yozakura_statusbar_category);
    }
}
