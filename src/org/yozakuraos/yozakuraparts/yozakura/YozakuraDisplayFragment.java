...
public class YozakuraDisplayFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.yozakura_display);
        getActivity().setTitle(R.string.yozakura_display_category);
    }
}
